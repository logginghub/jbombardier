...
# Application
APP_NAME="jbombardier Agent"
APP_LONG_NAME="Vertex Labs Performance Testing Agent"
...
# description: Vertex Labs Performance Testing Agent
...
### BEGIN INIT INFO
# Provides: jbombardier Agent
# Required-Start: $local_fs $network $syslog
# Should-Start: 
# Required-Stop:
# Default-Start: 2 3 4 5
# Default-Stop: 0 1 6
# Short-Description: Vertex Labs Performance Testing Agent
