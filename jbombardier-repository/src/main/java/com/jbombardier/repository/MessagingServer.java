...
public class MessagingServer implements Closeable {
    ...
    private static final Logger logger = Logger.getLoggerFor(MessagingServer.class);
    private RepositoryController controller;

    public MessagingServer(final RepositoryController controller) {
        this.controller = controller;
        server = new Level3AsyncServer("RepositoryMessaging3Server");
    }
