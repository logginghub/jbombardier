...
import com.jbombardier.common.LocalTestRunner;
import com.jbombardier.common.PerformanceTestAdaptor;
import com.jbombardier.common.TestContext;

public class TestB extends PerformanceTestAdaptor {

    private Random random = new Random();

    public void runIteration(TestContext pti) throws Exception {
        pti.startTransaction("transactionB");
        int millis = random.nextInt(100);
        Thread.sleep(millis);
        pti.endTransaction("transactionB");        
    }

    public static void main(String[] args) throws Exception {
        LocalTestRunner.run(new TestB(), 1000, new DefaultPropertiesProvider());
    }
}
