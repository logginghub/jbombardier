 ...
 */
public class ConsoleSleepTestWithPhasesAndWarmups {
    public static void main(String[] args) {

        configurationBuilder().testName("Phases Sample")
                              .addEmbeddedAgent()
                              .addPhase(phase("Phase 1").duration("10 seconds").warmup("5 seconds").addTest(test(
                                      SleepTest.class).name("sleep 10@100")
                                                      .properties("delay=10")
                                                      .targetRate(100)
                                                      .rateStep(100)
                                                      .threads(10)
                                                      .threadStep(10)
                                                      .sla(10)))
                              .addPhase(phase("Phase 2").duration("11 seconds").warmup("6 seconds").addTest(test(
                                      SleepTest.class).name("sleep 25@40")
                                                      .properties("delay=25")
                                                      .targetRate(40)
                                                      .rateStep(40)
                                                      .sla(25)))
                              .addPhase(phase("Phase 3").duration("12 seconds").warmup("7 seconds").addTest(test(SleepTest.class).name("sleep 100@10")
