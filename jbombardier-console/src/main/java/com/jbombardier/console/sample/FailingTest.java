...
/**
 * Benchmark test uses the context fail method to simulate a test failure.
 * 
 * @author James
 */
public class FailingTest extends PerformanceTestAdaptor {

    private String failureReason;

    @Override public void setup(TestContext pti) throws Exception {
        failureReason = pti.getProperty("failureReason");
    }
        
    public void runIteration(TestContext pti) throws Exception {
        pti.fail(failureReason);          
    }
}
